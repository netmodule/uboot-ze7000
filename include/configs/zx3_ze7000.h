...
#define CONFIG_EXTRA_ENV_SETTINGS   \
	...
	"sdboot=echo Booting from SD Card...;" \
        "nand device 0;" \
        "ext2load mmc 0:2 0x3000000 /boot/uImage;" \
        "ext2load mmc 0:2 0x2A00000 /boot/devicetree.dtb;" \
        "run sdargs;" \
        "bootm 0x3000000 - 0x2A00000\0" \
...
#define CONFIG_SYS_I2C_SPEED        100000  /* I2C speed and slave address */
                                            /* i2c_init() of Zynq I2C driver ignores this value! */
...
#define CONFIG_FPGA_PRJREF_STRING    (0x40080000)


#define CONFIG_FPGA_VERSION_MINOR_FSB   (0)
#define CONFIG_FPGA_VERSION_MINOR_BITS  (8)
#define CONFIG_FPGA_VERSION_MINOR_MASK  (((1 << CONFIG_FPGA_VERSION_MINOR_BITS) - 1) << CONFIG_FPGA_VERSION_MINOR_FSB)
#define CONFIG_FPGA_VERSION_MAJOR_FSB   (8)
#define CONFIG_FPGA_VERSION_MAJOR_BITS  (8)
